...
Usage:
    python /work/nvme/bbjs/sbharadwaj/powsm/xeuspr/src/recipe/phone_recognition/local/run_epitran.py \
          /work/hdd/bbjs/shared/powsm/s2t1/dump/raw/test_gmuaccent/text.good --output exp/data/epitran_outputs/gmuaccent.epitran
