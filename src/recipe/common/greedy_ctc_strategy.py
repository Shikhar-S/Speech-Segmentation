...
class GreedyCTCInference:
    ...
    def __call__(
        ...
        **kwargs,
        ...
        # 2. Greedy search.
        # Optionally restrict the output vocab by masking.
        if self.masked_token_ids is not None:
            logits[..., self.masked_token_ids] = float("-inf")
        ...
        for b, ids in enumerate(collapsed_ids):
            ...
            # NOTE(shikhar): Hacky, tokenizer should maintain a special token list
            clean_tokens = [
