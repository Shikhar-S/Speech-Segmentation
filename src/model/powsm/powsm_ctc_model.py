...
PhoneBench's probing/forced-alignment pipeline expects the following interface from net:
...
as mandatory inputs to the encoder. This wrapper generates default values when PhoneBench
does not provide them.

Core principle: **Use upstream ESPnet2 implementation as-is** and only add a thin wrapper
for PhoneBench's needs.
"""
...
class PowsmCTCNet(torch.nn.Module):
    """Thin wrapper exposing PhoneBench-friendly methods around ESPnetS2TCTCModel."""
