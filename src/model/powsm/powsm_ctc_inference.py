...
This module intentionally keeps PhoneBench's Hydra/distributed inference contract,
...
def patch_espnet_config_paths(
    *,
    ...
    In PhoneBench, assets live under `work_dir`, so we patch them to absolute paths.
    """
...
class PowsmCTCInference:
    """PhoneBench wrapper around ESPnet's Speech2TextGreedySearch (CTC greedy)."""
