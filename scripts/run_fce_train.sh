#!/bin/bash
# Train FCE (frame-wise cross-entropy) segmentation model on TIMIT train
# split with a WavLM-large backbone.
#
# Submit:
#   sbatch scripts/run_fce_train.sh
#   sbatch scripts/run_fce_train.sh trainer.max_steps=20000   # override
#
#SBATCH -A bbjs-delta-gpu
#SBATCH -p gpuA40x4,gpuA100x4
#SBATCH -J seg-fce-wavlm
#SBATCH -N 1
