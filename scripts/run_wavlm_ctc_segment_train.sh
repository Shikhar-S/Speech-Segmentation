...
#
# Submit:
#   sbatch scripts/run_wavlm_ctc_segment_train.sh
#   sbatch scripts/run_wavlm_ctc_segment_train.sh trainer.max_steps=30000   # override
#
#SBATCH -A bbjs-delta-gpu
#SBATCH -p gpuA40x4,gpuA100x4
#SBATCH -J wavlm-ctc-seg
#SBATCH -N 1
...
srun python src/main.py \
  experiment=train/wavlm_ctc_segment \
  "$@"
