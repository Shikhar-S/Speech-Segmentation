...
Options:
  --model LIST        Models: logmel, powsm, powsmvr, powsm_ctc, ctag, lv60, xlsr53, huper, koel, zipactc, zipactc_ns, or "all"
...
declare -A model_configs=(
    ...
    ["huper"]="huper|huper29/huper_recognizer"
    ["koel"]="koel|KoelLabs/xlsr-english-01"
